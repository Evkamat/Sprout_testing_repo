...
# Contributing to Sprout_testing_repo

This outlines how to propose a change to Sprout_testing_repo.
...
-   Fork the package and clone onto your computer.
    If you haven't done this before, we recommend using `usethis::create_from_github("Evkamat/Sprout_testing_repo", fork = TRUE)`.
...
Please note that the Sprout_testing_repo project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md).
